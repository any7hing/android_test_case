# Тестовое задание на позицию  Junior Android реверс инженер
...
## Использование
- Склонируйте репозиторий, установите переменные окружения в файле .env, установите зависимости, подключите телефон для теста, запустите сервер.
